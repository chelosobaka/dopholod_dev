...
class CellsTest < ApplicationSystemTestCase
  ...
  test "creating a Cell" do
    ...
    fill_in "Dimensions", with: @cell.dimensions
    fill_in "Net weight", with: @cell.net_weight
    fill_in "Packed sizes", with: @cell.packed_sizes
    fill_in "Product id", with: @cell.product_id_id
    fill_in "Space", with: @cell.space
    fill_in "Temperature range", with: @cell.temperature_range
